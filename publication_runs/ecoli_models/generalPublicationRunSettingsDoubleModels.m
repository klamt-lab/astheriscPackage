...
reactionsWithSetMinimumZero = ["R_ATPM_ecoli1", "R_ATPM_ecoli2"];
ignoredMetabolites = [
    "M_h2o_c_ecoli1", "M_h2o_c_ecoli2",...
    "M_h2o_p_ecoli1", "M_h2o_p_ecoli2",...
    "M_h2o_e_ecoli1", "M_h2o_e_ecoli2",...
    "M_h2o_exchg",...
    "M_h_c_ecoli1", "M_h_c_ecoli2",...
    "M_h_p_ecoli1", "M_h_p_ecoli2",...
    "M_h_e_ecoli1", "M_h_e_ecoli2",...
    "M_h_exchg"
];
