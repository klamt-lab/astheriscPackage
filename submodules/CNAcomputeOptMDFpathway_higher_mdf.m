function [mdf, v, conc, dfs]= CNAcomputeOptMDFpathway_higher_mdf(maximalMilpRunTime, minimal_mdf, minimize_flux_sum, cnap, RT, G0, Cmin, Cmax, D, d, fixed_ratios)
%
...
[mdf, v, conc, dum1, dum2, dfs, ~, ~, ~, obj]= max_min_driving_force_pathway_higher_mdf(maximalMilpRunTime, minimal_mdf, minimize_flux_sum, stoichMat,...
