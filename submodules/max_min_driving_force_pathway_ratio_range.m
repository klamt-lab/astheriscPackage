function [mmdf, fv, x, min_df, max_df, dfs, fva_lb, fva_ub, reac_map, obj, z_vars, flux_vars, c_vars, first_z, first_fv, deltaGf]= max_min_driving_force_pathway_ratio_range(maximalMilpRunTime, stoichMat, st, reacMin,...
