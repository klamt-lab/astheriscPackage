function [mmdf, fv, x, min_df, max_df, dfs, fva_lb, fva_ub, reac_map, obj, z_vars, flux_vars, c_vars, first_z, first_fv, deltaGf, mmdf_var]= max_min_driving_force_pathway_higher_mdf(maximalMilpRunTime, minimal_mdf, minimize_flux_sum, stoichMat, st, reacMin,...
