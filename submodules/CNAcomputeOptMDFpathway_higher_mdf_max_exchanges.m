...
[mdf, v, conc, dum1, dum2, dfs, ~, ~, ~, obj]= max_min_driving_force_pathway_higher_mdf_max_exchanges(maximalMilpRunTime, numMaxExchanges, exchange_reaction_indices, minimal_mdf, minimize_flux_sum, stoichMat,...
