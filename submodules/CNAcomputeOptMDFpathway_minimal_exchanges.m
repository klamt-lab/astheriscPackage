function [mdf, v, conc, dfs, number_of_extra_exchanges]= CNAcomputeOptMDFpathway_minimal_exchanges(maximalMilpRunTime, minimal_mdf, exchange_reaction_ids, maximalNumberExchangeReactions, cnap, RT, G0, Cmin, Cmax, D, d, fixed_ratios)
%
...
[mdf, v, conc, dum1, dum2, dfs, fva_lb, fva_ub, reac_map, number_of_extra_exchanges]= max_min_driving_force_pathway_minimal_exchanges(maximalMilpRunTime, minimal_mdf, exchange_reaction_ids,...
    maximalNumberExchangeReactions, stoichMat,...
    cnap.stoichMat(cnap.specInternal, :), cnap.reacMin, cnap.reacMax, D, d,...
    1e-6, [], 1000, RT, G0, Cmin, Cmax, fixed_ratios,...
