function [mdf, v, conc, dfs]= CNAcomputeOptMDFpathway_ratio_range_redcom(maximalMilpRunTime, reactionSpeciesIndexMapping, cnap, RT, G0, Cmin, Cmax, D, d, fixed_ratios)
%
...
[mdf, v, conc, dum1, dum2, dfs, ~, ~]= max_min_driving_force_pathway_ratio_range_redcom(maximalMilpRunTime, reactionSpeciesIndexMapping, stoichMat,...
